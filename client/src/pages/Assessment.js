...
import { Row, Col, ListGroup, ListGroupItem, ListGroupItemHeading, Button } from "reactstrap";
...
class Assessment extends Component {
    ...
    handleClick = index => {
        axios.post('/course/assessment/delete', {
            module_code: this.props.module_code,
                    ...
                    <Col>
                        <Row className="mt-5">
                            ...
                            <Col className='mt-2' sm={{ size: 3, order: 2 }}>
                                <FormA firstPostRoute='/course/assessment/add' data={{ "module_code": this.props.module_code }} buttonLabel='Create Assessment' formHeader='Create Assessment' firstField='Assessment Title' secondField='Max Marks' action='Create' />
                            </Col>
                        </Row>
